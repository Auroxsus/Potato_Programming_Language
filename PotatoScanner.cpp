// PotatoScanner.cpp by Auroxsus
// French Fry Productions
// Description: POTATO Scanner "lexical analysis" program
//-----------------------------------------------------------
#include <iostream>
#include <iomanip>
...
//-----------------------------------------------------------
{
	...
	lister.ListInformationLine("******* POTATO scanner ending");
	cout << "POTATO scanner ending\n";
